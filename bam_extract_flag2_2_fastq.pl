...
##########################################################################################
#
#	Script takes a sorted, indexed bam file from paired-end alignments and extracts the pairs
#	that BOTH do not map [-f 77 and -f 141] --> creates fastq files of paired reads.
#	
##########################################################################################
    \nYou did not provide enough information...  Usage: perl script_name.pl [OPTIONS]
    -b\t.bam file
    -o\tOutfile name [pair1.fastq or pair2.fastq will be appended to end]\n\n";

my (%opt, $outfile, $bam_file);
